...
describe('ContentfulService', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [
        { provide: CONTENTFUL_SPACE, useValue: 'space' },
        { provide: CONTENTFUL_ACCESS_TOKEN, useValue: 'access token' },
        { provide: CONTENTFUL_ENVIRONMENT, useValue: 'test' },
      ],
    });
  ...
  it('should transform the promise of entries into an observable', () => {
    const getEntriesSpy = jest
      .spyOn(service['cdaClient'], 'getEntries')
  ...
  it('should get the list of tags', () => {
    const getTagsSpy = jest
      .spyOn(service['cdaClient'], 'getTags')
      .mockImplementation(() => Promise.resolve(tags));

    service.getTags().subscribe((collection: TagCollection) => {
      expect(collection.items === tags.items);
    });
